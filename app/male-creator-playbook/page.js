      ...
      <main className="pb-page">
        <div className="pb-hero">
          ...
          <h1 className="pb-title">
            Sistem koji stoji iza muških kreatora<br />
            <span style={{ color: '#a9875c' }}>koji zarađuju $30K–$50K mesečno.</span>
          </h1>
          <p className="pb-sub">8 poglavlja. Kompletan sistem za izgradnju i skaliranje muških kreatorskih naloga. Muški kreatori su masivno nedovoljno posluženi, publika plaća više, a ličnost je praznina koju niko ne popunjava. Ovo je kako je popuniti.</p>

          <div className="pb-stats">
            {[
              { num: '2–3×', label: 'više PPV troše' },
              { num: '$120–250', label: 'prosečan LTV' },
              { num: '$30K+', label: 'mesečni potencijal' },
        ...
        <div className="container">
          <div className="pb-section">
            ...
            <div className="pb-learn-grid">
              {[
                'Zašto je muško kreatorsko tržište nedovoljno posluženo i kako iskoristiti tu prednost',
                'Izgradi brend arhetip koji te odvaja od svakog tihog physique naloga',
                'Mapiraj ciljnu publiku i razumi psihologiju gej/bi muškog kupca',
                'Podesiti OnlyFans nalog sa trekking linkovima i besplatnim trial levkom',
                'Sistem višekratnog korišćenja sadržaja iz jednog teretana snimanja nedeljno',
                'Pokreni čatovanje i PPV eskalaciju prilagođenu muškim publikama',
              ].map(item => (
          ...
          <div className="pb-cta-box">
            <h2 className="pb-cta-title">Spreman da skaliraš?</h2>
            <p className="pb-cta-sub">Pomažemo i muškim kreatorima da izgrade i skaliraju svoje naloge. Prijavi se i vidi da li si kvalifikovan.</p>
