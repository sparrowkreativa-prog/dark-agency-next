  ...
  return (
    <div className={montserrat.variable}>
        ...
        <div className="nav-container">
          ...
          <nav className="nav-links">
            <ul className="nav-menu">
              ...
              <li><a href="#" style={{ color: '#e8538f', fontWeight: 600 }}>Čet Strategija</a></li>
            </ul>
          </nav>
      ...
      <style>{`
        ...
        .cs-check-list li::before { content: '✓'; position: absolute; left: 0; color: #e8538f; font-weight: 700; font-size: 0.85rem; }
